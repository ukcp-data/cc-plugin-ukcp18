...
class UKCP18OSGBFileCheck(BaseNCCheck):
    ...
    def check_osgbf_001(self, ds):
        return check_package.NCCoordVarHasBoundsCheck(kwargs={'var_id': 'projection_x_coordinate'},
                                                    level="HIGH",
                                                    vocabulary_ref="")(ds)
    
    def check_osgbf_002(self, ds):
        return check_package.NCCoordVarHasBoundsCheck(kwargs={'var_id': 'projection_y_coordinate'},
                                                    level="HIGH",
                                                    vocabulary_ref="")(ds)
